...
@register_model("hubert_new", dataclass=HubertConfig)
class HubertModel(BaseFairseqModel):
    ...
    def forward(
        ...
        if features_only:
            return {"x": x, "padding_mask": padding_mask, "features": features, "mask_indices": mask_indices}
    ...
    def extract_features(
        ...
        return feature, res["padding_mask"], res["mask_indices"]
